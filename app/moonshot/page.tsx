      ...
      <section className="mx-auto max-w-6xl">
        <div className="rounded-3xl bg-gray-950 p-8">
          ...
          <p className="mt-4 max-w-3xl text-gray-300">
            ...
            connection, moonshot tracking, and your roadmap checklist to stay
            disciplined.
          </p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <a
            ...
            className="block rounded-2xl bg-gray-900 p-6 hover:bg-gray-800"
          >
            <h2 className="text-2xl font-bold">Moonshot Scanner</h2>
            <p className="mt-2 text-gray-400">
              Score high-risk speculative trade ideas.
            </p>
            <p className="mt-4 font-bold text-blue-400">
              Open Moonshot Scanner →
            </p>
          </a>
        </div>
        ...
        <div className="mt-8 rounded-2xl bg-gray-900 p-6">
          <div className="flex items-center justify-between">
            ...
            <p className="font-bold text-green-400">8 Core Pages Built</p>
          </div>

          <div className="mt-4 h-4 rounded-full bg-gray-700">
            <div className="h-4 w-full rounded-full bg-green-500"></div>
          </div>

          <p className="mt-3 text-gray-400">
            Current features: Roadmap, Paper Trading, Wheel Bot, Growth
            Calculator, Prop Firm Tracker, AI Coach, Alpaca Paper Connection,
            and Moonshot Scanner. Next upgrades: settings, database storage,
            GitHub, Vercel deployment, and secure backend APIs.
          </p>
        </div>
